...
CONFIG_ARCHIVE_MAP_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("trust_gemma", "GEMMA_PRETRAINED_CONFIG_ARCHIVE_MAP"),
        ...
        ("trust_llama", "LLAMA_PRETRAINED_CONFIG_ARCHIVE_MAP"),
